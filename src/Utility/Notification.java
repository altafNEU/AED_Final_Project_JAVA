...
public class Notification {
    ...
    public Notification() {
        this.fromEmail = "satyajitdas.sapabap@gmail.com";
        ...
        this.emailPassword = "ypczouqdjbchkiqo";
    }
    ...
    public void sendSms(String phoneNum, String smsContent) {
        // COMMENTED this Code BECAUSE TWILLIO is Paid; working fine assume sms will go if you see the console log below
